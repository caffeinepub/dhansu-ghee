...
import type { Order as _Order, OrderStatus as _OrderStatus, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createStripeCheckout(arg0: bigint, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createStripeCheckout(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProduct(): Promise<GheeProduct> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: GheeProduct): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        paymentId: record_opt_to_undefined(from_candid_opt_n8(_uploadFile, _downloadFile, value.paymentId)),
